    ...
    <main className="pt-32 pb-16 sm:pt-40 sm:pb-24 lg:pb-32 overflow-hidden">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Link
            href="/signup"
            className="h-12 w-full sm:w-auto px-8 bg-green-600 hover:bg-green-700 text-white rounded-(--radius) font-semibold text-lg transition-all shadow-lg hover:shadow-xl hover:-translate-y-px flex items-center justify-center gap-2"
          >
            Get started
          </Link>
        </div>
